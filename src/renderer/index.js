...
// --- Initialization ---
Promise.all([api.checkNmap(), api.settings.checkDependency('tshark'), api.settings.checkDependency('hydra'), api.settings.checkDependency('msfrpcd')]).then(async ([isNmapInstalled, tsharkStatus, hydraStatus, msfrpcdStatus]) => {
